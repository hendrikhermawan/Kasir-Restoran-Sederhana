    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item d-flex align-items-center">
                    <img src="{{ asset('images/logo chef.png') }}" class="img-circle mr-2" alt="User Image" style="width: 25px; height: 25px;">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="{{ asset('images/logo chef.png') }}" alt="Brand Logo">
                <span class="brand-text font-weight-bold text-white">TelkomResto</span>
            </a>
        ...
        <footer class="main-footer">
            ...
            <strong>&copy; 2025 <a href="#">Hendrik</a>.</strong> All rights reserved.
        </footer>
    </div>
